      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:py-3">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-2 rounded-full bg-green-deep px-5 py-2.5 text-sm font-semibold text-cream shadow-card transition-all hover:bg-green-mid focus:outline-none focus:ring-2 focus:ring-green-deep focus:ring-offset-2 focus:ring-offset-cream"
        ...
        {mobileOpen && (
          ...
          >
            <div className="px-6 py-4 space-y-1">
              ...
              <div className="pt-4">
                <button
                  className="flex w-full items-center justify-center gap-2 rounded-full bg-green-deep px-5 py-3 text-sm font-semibold text-cream"
                  style={{ fontFamily: "'Cormorant SC', Georgia, serif", letterSpacing: "0.06em" }}
                >
                  <Wallet size={15} />
                  Connect Wallet
